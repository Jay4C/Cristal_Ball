...
stl_file = u"A:/1_Professionnel/1_Holomorphe/2_Archives/2_Outils_Numeriques/Python__Flask__Cristal_Ball/Test/Service/Archives/CAO/2_Specials/Patent_US20150188400A1_Magnetic_Flywheel_Induction_EMG_aka_Hatem_Motor/Version_1/part_rotor.stl"

Mesh.export(__objs__, stl_file)

dxf_file = u"A:/1_Professionnel/1_Holomorphe/2_Archives/2_Outils_Numeriques/Python__Flask__Cristal_Ball/Test/Service/Archives/CAO/2_Specials/Patent_US20150188400A1_Magnetic_Flywheel_Induction_EMG_aka_Hatem_Motor/Version_1/part_rotor.dxf"
...
""")
        ...
        pywinauto.keyboard.send_keys(
            ...
            'Patent_US20150188400A1_Magnetic_Flywheel_Induction_EMG_aka_Hatem_Motor\\\\Version_1'
            '\\\\part_rotor.py"{)}.read{(}{)}{)}'
        )
    ...
    # ok
    def test_part_rotor_laser_cutting(self):
        print("test_part_rotor_laser_cutting")

        if os.path.exists("part_rotor_laser_cutting.py"):
            os.remove("part_rotor_laser_cutting.py")
        else:
            print("The file does not exist")

        # Writing to file
        with open("part_rotor_laser_cutting.py", "w") as file:
            # Writing data to a file
            file.write("""import FreeCAD, Part, Drawing, math, Mesh, importDXF
...
""")
        ...
        pywinauto.keyboard.send_keys(
            ...
            '\\\\Python__Flask__Cristal_Ball\\\\Test\\\\Service\\\\Archives\\\\CAO\\\\2_Specials\\\\'
            'Patent_US20150188400A1_Magnetic_Flywheel_Induction_EMG_aka_Hatem_Motor\\\\Version_1'
            '\\\\part_rotor_laser_cutting.py"{)}.read{(}{)}{)}'
        )
...
Gui.activeDocument().activeView().saveImage('A:/1_Professionnel/1_Holomorphe/2_Archives/2_Outils_Numeriques/Python__Flask__Cristal_Ball/Test/Service/Archives/Images_To_Videos/2_Specials/US20150188400A1/' + file + str(i) + '.png',1117,388,'Current')
        ...
        pywinauto.keyboard.send_keys(
            'exec{(}open{(}"A:\\\\1_Professionnel\\\\1_Holomorphe\\\\2_Archives\\\\2_Outils_Numeriques'
            '\\\\Python__Flask__Cristal_Ball\\\\Test\\\\Service\\\\Archives\\\\CAO\\\\2_Specials'
            '\\\\Patent_US20150188400A1_Magnetic_Flywheel_Induction_EMG_aka_Hatem_Motor'
            '\\\\Version_1\\\\assembly.py"{)}.read{(}{)}{)}'
        )
...
""")
        ...
        pywinauto.keyboard.send_keys(
            ...
            '\\\\Python__Flask__Cristal_Ball\\\\Test\\\\Service\\\\Archives\\\\CAO\\\\2_Specials'
            '\\\\Patent_US20150188400A1_Magnetic_Flywheel_Induction_EMG_aka_Hatem_Motor'
            '\\\\Version_1\\\\assembly_plant.py"{)}.read{(}{)}{)}'
        )
