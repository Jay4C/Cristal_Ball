...
z = 0
title = "part_support"
stl_file = u"C:/Users/Jason/Documents/Devs/Cristal_Ball/Archives/CAO/Mercorus/Version_7/Stl/" + title + ".stl"
...
# part_vis_metal_m18_120l
color = (0.90,0.50,0.40)
i2 = 6
title = 'part_vis_metal_m18_120l'
stl_file = u"C:/Users/Jason/Documents/Devs/Cristal_Ball/Archives/CAO/Mercorus/Version_7/Stl/" + title + ".stl"
for i in range(0, i2):
    degre = 60
    radius = e5/2
    ...
    x = radius*math.cos(alpha)
    y = radius*math.sin(alpha)
    z = - k_vis - marge_etancheite - h_rondelle
...
for i in range(i1, i1 + i3):
    ...
    x = radius*math.cos(alpha)
    y = radius*math.sin(alpha)
    z = - marge_etancheite*4 - h_ecrou - h_rondelle
...
# part_vis_metal_m18_50l
color = (0.90,0.50,0.40)
i4 = 6
title = 'part_vis_metal_m18_50l'
stl_file = u"C:/Users/Jason/Documents/Devs/Cristal_Ball/Archives/CAO/Mercorus/Version_7/Stl/" + title + ".stl"
for i in range(0, i4):
    degre = 60
    radius = e6/2
    ...
    x = radius*math.cos(alpha)
    y = radius*math.sin(alpha)
    z = - marge_etancheite*3 + k_vis + h_rondelle
...
for i in range(i6, i6 + i7):
    ...
    x = radius*math.cos(alpha)
    y = radius*math.sin(alpha)
    z = - marge_etancheite*3 + h_rondelle
    rotation = App.Rotation(App.Vector(0,1,0),180)
...
Mesh.export(__objs__,u"C:/Users/Jason/Documents/Devs/Cristal_Ball/Archives/CAO/Mercorus/Version_7/Stl/" + assembly + ".stl")

del __objs__

# Generate PNG files
file = 'C:\\Users\\Jason\\Documents\\Devs\\Cristal_Ball\\Archives\\CAO\\Mercorus\\Version_7\\Png\\' + assembly + '_'
# Ombré
