...
__objs__.append(FreeCAD.getDocument("part_coil").getObject("Shape"))

stl_file = u"A:/GitHub/Cristal_Ball/Archives/CAO/3_My_Inventions/Vibrating_Magnet_Electromagnetic_Generator/Flower/Version_5/Stl/part_coil.stl"
