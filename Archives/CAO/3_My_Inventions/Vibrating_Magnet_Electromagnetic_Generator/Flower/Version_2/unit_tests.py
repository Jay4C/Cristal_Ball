...
class UnitTestsVibratingMagnetElectromagneticGeneratorFlowerVersion2ForParts(unittest.TestCase):
    # ok
    # 3D printing
    def test_part_coil_40de(self):
        print('test_part_coil_40de')

        if os.path.exists("part_coil_40de.py"):
            os.remove("part_coil_40de.py")
        else:
            print("The file does not exist")

        # Writing to file
        with open("part_coil_40de.py", "w") as file:
            # Writing data to a file
            file.write("""import FreeCAD, Part, Mesh, math, importDXF

DOC = FreeCAD.activeDocument()

DOC_NAME = "part_coil_40de"
...
h_support = 0.8
Di = 20 + EPS
h_coil = l_vis_100 - h_magnet_40de_20di_10h*2 - h_support*10 - h_ecrou_20d_16m + EPS
De = 40 + EPS
Dp = 7 + EPS
E = 1 + EPS
...
__objs__.append(FreeCAD.getDocument("part_coil_40de").getObject("Shape"))

stl_file = u"A:/1_Professionnel/1_Holomorphe/2_Archives/2_Outils_Numeriques/My_Tools/Test/Service/Archives/CAO/3_My_Inventions/Vibrating_Magnet_Electromagnetic_Generator/Flower/Version_2/part_coil_40de.stl"
...
# Generate PNG files
file = 'part_coil_40de_'
# Ombré
Gui.runCommand('Std_DrawStyle',5)
i = 1
Gui.activeDocument().activeView().viewIsometric()
Gui.activeDocument().activeView().saveImage('A:/1_Professionnel/1_Holomorphe/2_Archives/2_Outils_Numeriques/My_Tools/Test/Service/Archives/Images_To_Videos/3_My_Inventions/VMEG/Flower/2/' + file + str(i) + '.png',1117,388,'Current')
...
""")
        ...
        pywinauto.keyboard.send_keys(
            'exec{(}open{(}"A:\\\\1_Professionnel\\\\1_Holomorphe\\\\2_Archives\\\\2_Outils_Numeriques\\\\My_Tools\\\\Test\\\\Service\\\\Archives\\\\CAO\\\\3_My_Inventions\\\\Vibrating_Magnet_Electromagnetic_Generator\\\\Flower\\\\Version_2\\\\part_coil_40de.py"{)}.read{(}{)}{)}'
        )
...
stl_file = u"A:/1_Professionnel/1_Holomorphe/2_Archives/2_Outils_Numeriques/My_Tools/Test/Service/Archives/CAO/3_My_Inventions/Vibrating_Magnet_Electromagnetic_Generator/Flower/Version_2/part_support.stl"

Mesh.export(__objs__, stl_file)

dxf_file = u"A:/1_Professionnel/1_Holomorphe/2_Archives/2_Outils_Numeriques/My_Tools/Test/Service/Archives/CAO/3_My_Inventions/Vibrating_Magnet_Electromagnetic_Generator/Flower/Version_2/part_support.dxf"
...
""")
        ...
        pywinauto.keyboard.send_keys(
            'exec{(}open{(}"A:\\\\1_Professionnel\\\\1_Holomorphe\\\\2_Archives\\\\2_Outils_Numeriques\\\\My_Tools\\\\Test\\\\Service\\\\Archives\\\\CAO\\\\3_My_Inventions\\\\Vibrating_Magnet_Electromagnetic_Generator\\\\Flower\\\\Version_2\\\\part_support.py"{)}.read{(}{)}{)}'
        )
...
b = 0
for i in range(0, 5):
    folder = u"A:/1_Professionnel/1_Holomorphe/2_Archives/2_Outils_Numeriques/My_Tools/Test/Service/Archives/CAO/3_My_Inventions/Vibrating_Magnet_Electromagnetic_Generator/Flower/Version_2/"
    file = "part_support"
...
""")
        ...
        pywinauto.keyboard.send_keys(
            'exec{(}open{(}"A:\\\\1_Professionnel\\\\1_Holomorphe\\\\2_Archives\\\\2_Outils_Numeriques\\\\My_Tools\\\\Test\\\\Service\\\\Archives\\\\CAO\\\\3_My_Inventions\\\\Vibrating_Magnet_Electromagnetic_Generator\\\\Flower\\\\Version_2\\\\assembly.py"{)}.read{(}{)}{)}'
        )
