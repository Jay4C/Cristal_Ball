...
class UnitTestsRPATradingEtoro(unittest.TestCase):
    ...
    def test_login(self):
        ...
        user_agent = "Mozilla/5.0 (Linux; Android 8.0.0; Pixel 2 XL Build/OPD1.170816.004) Chrome/67.0.3396.87 Mobile Safari/537.36"

        # With FirefoxOptions
        options = webdriver.FirefoxOptions()
        # options.set_preference("dom.webnotifications.serviceworker.enabled", False)
        # options.set_preference("dom.webnotifications.enabled", False)
        options.set_preference("general.useragent.override", "userAgent=" + user_agent)
        ...
        sign_in_button = browser.find_element(
            by=By.XPATH,
            value='/html/body/app-root/et-layout-main/div/div/div/div/div/ui-layout/ng-view/et-login/et-login-sts/div/div/div/form/button'
        )
    ...
    #
    def test_place_one_trade_for_gbpusd_from_virtual_portfolio(self):
        print('test_place_one_trade_for_gbpusd_from_virtual_portfolio')
        ...
        market = 'https://www.etoro.com/markets/gbpusd'
