...
class UnitTestsDesktopAutomationYellowPagesItaly(unittest.TestCase):
    def test_click_on_button_email_for_one_page_without_ocr_for_distributing_open_source_code_for_garage_in_italy(self):
        ...
        if soup_company.find("a", {"class": "icn-contattaci"}) is not None:
            ...
            myMessage = (
                    "Good{VK_SPACE}morning," +
                    "{ENTER}" +
                    "{ENTER}" +
                    "Please{VK_SPACE}see{VK_SPACE}the{VK_SPACE}following{VK_SPACE}inventions{VK_SPACE}of{VK_SPACE}" +
                    "Stanley{VK_SPACE}Meyer{VK_SPACE}on{VK_SPACE}GitHub{VK_SPACE}:{VK_SPACE}" +
                    "https://github.com/Jay4C/Free-energy-devices/tree/master/Stanley_Meyer{VK_SPACE}for{VK_SPACE}" +
                    "building{VK_SPACE}hydrogen{VK_SPACE}technologies{VK_SPACE}for{VK_SPACE}cars{VK_SPACE}and{VK_SPACE}" +
                    "other{VK_SPACE}processes." +
                    "{ENTER}" +
                    "{ENTER}" +
                    "We{VK_SPACE}would{VK_SPACE}be{VK_SPACE}able{VK_SPACE}to{VK_SPACE}reuse{VK_SPACE}some{VK_SPACE}" +
                    "CAD{VK_SPACE}files{VK_SPACE}of{VK_SPACE}the{VK_SPACE}inventions{VK_SPACE}of{VK_SPACE}Stanley" +
                    "{VK_SPACE}Meyer{VK_SPACE}from{VK_SPACE}GitHub{VK_SPACE}:{VK_SPACE}" +
                    "https://github.com/Jay4C/Python-Macros-For-FreeCAD" +
                    "{ENTER}" +
                    "{ENTER}" +
                    "Have{VK_SPACE}a{VK_SPACE}nice{VK_SPACE}day,"
            )
