...
class UnitTestsDesktopAutomationYouTube(unittest.TestCase):
    def test_list_all_articles_from_one_folder(self):
        path = "C:\\Users\\DELL\\Documents\\Outils\\Text_To_Videos\\videos_creees\\Codedeléner_[Fait]_[Fini]"

        dirs = os.listdir(path)

        files = []

        debut_article = "Code de l'énergie - Article "
    ...
    def test_insert_one_video(self):
        ...
        pywinauto.keyboard.send_keys("C:\\Users\\DELL\\Documents\\Outils\\Text_To_Videos\\videos_creees\\Codedeléner_[Fait]_[Fini]")
        ...
        # Type the filename
        pywinauto.keyboard.send_keys("3_Article_L100_2.avi")
        ...
        pywinauto.keyboard.send_keys("Code{VK_SPACE}de{VK_SPACE}l'énergie{VK_SPACE}-{VK_SPACE}Article{VK_SPACE}L100{VK_SPACE}2")
        ...
        pywinauto.keyboard.send_keys("Vu{VK_SPACE}l'arrêté{VK_SPACE}du{VK_SPACE}24{VK_SPACE}juin{VK_SPACE}"
                                     "2014{VK_SPACE}relatif{VK_SPACE}à{VK_SPACE}la{VK_SPACE}gratuité{VK_SPACE}"
                                     "de{VK_SPACE}la{VK_SPACE}réutilisation{VK_SPACE}"
                                     "des{VK_SPACE}bases{VK_SPACE}de{VK_SPACE}données{VK_SPACE}juridiques{VK_SPACE}"
                                     "et{VK_SPACE}associatives{VK_SPACE}de{VK_SPACE}la{VK_SPACE}direction"
                                     "{VK_SPACE}de{VK_SPACE}"
                                     "l'information{VK_SPACE}légale{VK_SPACE}et{VK_SPACE}administrative"
                                     "{VK_SPACE}et{VK_SPACE}www.legifrance.gouv.fr")
    ...
    def test_insert_several_videos_on_youtube(self):
        ...
        playlist = "{VK_SPACE}-{VK_SPACE}Code{VK_SPACE}de{VK_SPACE}l'énergie"
