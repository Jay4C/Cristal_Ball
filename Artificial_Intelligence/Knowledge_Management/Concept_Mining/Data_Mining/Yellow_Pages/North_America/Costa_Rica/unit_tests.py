...
class UnitTestsDataMinerYellowPagesCostaRica(unittest.TestCase):
    #
    def test_extract_email_from_one_result(self):
        ...
        url = "https://www.kolbi1155.com/costa-rica/negocios/ocean-front-hotel-villas-marea-brava/125-norte-de"
        ...
        if soup.find("li", {'class': 'profile-menu-website'}) is not None:
            email = "info@" + soup \
                ...
                .find("a") \
                .get("href") \
                .replace('https://www.kolbi1155.com/redirector.php?yelref=http%3A%2F%2F', '') \
                .replace('https://www.kolbi1155.com/redirector.php?yelref=https%3A%2F%2F', '') \
                .replace('www.', '') \
                .replace('%2F', '') \
                .split('/')[0]
    ...
    def test_extract_each_email_from_one_page_of_results_for_one_activity_and_one_capital(self):
        ...
        url = "https://www.kolbi1155.com/costa-rica/hotel/pageno=1"
        ...
        if soup.find("h2", {'class': 'h4'}) is not None:
            ...
            for a in all_a:
                url = "https://www.kolbi1155.com" + a.find('a').get('href')
    ...
    def test_extract_each_email_from_all_pages_of_results_for_one_activity_and_one_capital(self):
        ...
        url_page = "https://www.kolbi1155.com/" + city + "/" + activity
        ...
        if soup.find("span", {"class": "company-search hidden-mobile lighter"}) is not None:
            number_of_pages_with_coma = int(soup.find("span", {"class": "company-search hidden-mobile lighter"})
                                            .text
                                            .split("resultados")[0]
                                            .replace(" ", "")
                                            ) / 24
    ...
    def test_extract_each_email_from_all_pages_of_results_for_all_activities_and_all_capitals(self):
        ...
        capitales_du_monde = [
            {'id': '953', 'nom': 'costa-rica', 'pays': 'costa-rica'},
        ]
                ...
                for activite in activites:
                    ...
                    if soup.find("span", {"class": "company-search hidden-mobile lighter"}) is not None:
                        number_of_pages_with_coma = int(
                            soup.find("span", {"class": "company-search hidden-mobile lighter"})
                            .text
                            .split("resultados")[0]
                            .replace(" ", "")
                            ) / 24
                                    ...
                                    for a in all_a:
                                        ...
                                        if soup.find("li", {'class': 'profile-menu-website'}) is not None:
                                            email = "info@" + soup \
                                                ...
                                                .get("href") \
                                                .replace(
                                                'https://www.kolbi1155.com/redirector.php?yelref=http%3A%2F%2F', '') \
                                                .replace(
                                                'https://www.kolbi1155.com/redirector.php?yelref=https%3A%2F%2F', '') \
                                                .replace('www.', '') \
                                                .replace('%2F', '') \
                                                .split('/')[0]
