...
class UnitTestsDataMinerYellowPagesGuatemala(unittest.TestCase):
    def test_extract_email_from_one_result(self):
        ...
        url = "https://www.paginasamarillas.com.gt/empresas/hotel-mayestic/guatemala-30124987?ad=80551175"
    ...
    def test_extract_each_email_from_one_page_of_results_for_one_activity_and_one_capital(self):
        ...
        url = "https://www.paginasamarillas.com.gt/guatemala/servicios/hoteles?page=1"
    ...
    def test_extract_each_email_from_all_pages_of_results_for_one_activity_and_one_capital(self):
        ...
        url_page = "https://www.paginasamarillas.com.gt/" + city + "/servicios/" + activity
    ...
    def test_extract_each_email_from_all_pages_of_results_for_all_activities_and_all_capitals(self):
        ...
        capitales_du_monde = [
            {'id': '702', 'nom': 'alta-verapaz', 'pays': 'Guatemala'},
            {'id': '703', 'nom': 'baja-verapaz', 'pays': 'Guatemala'},
            {'id': '704', 'nom': 'chimaltenango', 'pays': 'Guatemala'},
            {'id': '705', 'nom': 'chiquimula', 'pays': 'Guatemala'},
            {'id': '706', 'nom': 'el-progreso', 'pays': 'Guatemala'},
            {'id': '707', 'nom': 'escuintla', 'pays': 'Guatemala'},
            {'id': '708', 'nom': 'guatemala', 'pays': 'Guatemala'},
            {'id': '709', 'nom': 'huehuetenango', 'pays': 'Guatemala'},
            {'id': '710', 'nom': 'izabal', 'pays': 'Guatemala'},
            {'id': '711', 'nom': 'jalapa', 'pays': 'Guatemala'},
            {'id': '712', 'nom': 'jutiapa', 'pays': 'Guatemala'},
            {'id': '713', 'nom': 'peten', 'pays': 'Guatemala'},
            {'id': '714', 'nom': 'quetzaltenango', 'pays': 'Guatemala'},
            {'id': '715', 'nom': 'quiche', 'pays': 'Guatemala'},
            {'id': '716', 'nom': 'retalhuleu', 'pays': 'Guatemala'},
            {'id': '717', 'nom': 'sacatepequez', 'pays': 'Guatemala'},
            {'id': '718', 'nom': 'san-marcos', 'pays': 'Guatemala'},
            {'id': '719', 'nom': 'santa-rosa', 'pays': 'Guatemala'},
            {'id': '720', 'nom': 'solola', 'pays': 'Guatemala'},
            {'id': '721', 'nom': 'suchitepequez', 'pays': 'Guatemala'},
            {'id': '722', 'nom': 'totonicapan', 'pays': 'Guatemala'},
            {'id': '723', 'nom': 'zacapa', 'pays': 'Guatemala'},
        ]
