...
class UnitTestsDataMinerEmailNigeria(unittest.TestCase):
    def test_extract_one_email(self):
        try:
            url = "http://www.yellnigeria.com/listing/adesua-hotel-suites-and-events-centre/40044/hotels"
            ...
            try:
                if soup\
                        .find("div", {"class": "listing-detail"}) is not None:
                    try:
                        if soup\
                                .find("div", {"class": "listing-detail"})\
                                .find("div", {"class", "website"}) is not None:

                            try:
                                if soup \
                                        .find("div", {"class": "listing-detail"}) \
                                        .find("div", {"class", "website"})\
                                    ...
                                    try:
                                        if validate_email(email, verify=True) != False:
                                            print("The email : " + email + " exists.")
                                        else:
                                            print("The email : " + email + " doesn't exist.")
                                    except Exception as e:
                                        print("error with the email : " + email + " : " + str(e))
                                else:
                                    print("no a target _blank")
                            except Exception as e:
                                print("error a target _blank : " + str(e))
                        else:
                            print("no div class website")
                    except Exception as e:
                        print("error div class website : " + str(e))
                else:
                    print("no email business")
            except Exception as e:
                print("error div class listing-detail")
        except Exception as e:
            print("error base url : " + str(e))
                ...
                for activite in activites:
                    try:
                        try:
                                                                                ...
                                                                                if soup \
                                                                                    ...
                                                                                    if soup \
                                                                                        ...
                                                                                        if soup \
                                                                                                ...
                                                                                                if validate_email(email, verify=True) != False:
                                                                                                    ...
                                                                                                    with connection.cursor() as cursor:
                                                                                                        try:
                                                                                                            ...
                                                                                                            print(str(
                                                                                                                i_1) + " The record already exists : " + str(
                                                                                                                email))
                                                                                                            connection.close()
                                                                                                else:
                                                                                                    print(str(
                                                                                            ...
                                                                                            print(str(
                                                                                                i_1) + " No email business")
                                                                                    else:
                                                                                        print(str(
                                                                                            i_1) + " No email business")
                                                                                else:
                                                                                    print(
                                                                                        str(i_1) + " No email business")
                                                                            except Exception as e:
                                                                                print(
                                                                                    "error id section_CTA : " + str(e))
                                                                        except Exception as e:
                                                                            print("error url_result : " + str(e))
                                                                except Exception as e:
                                                                    print("error header h2 itemprop name : " + str(e))
                            ...
                            print("url activite capitale : " + str(e))
                    except Exception as e:
                        print("url : " + str(e))
        finally:
            print('done')
