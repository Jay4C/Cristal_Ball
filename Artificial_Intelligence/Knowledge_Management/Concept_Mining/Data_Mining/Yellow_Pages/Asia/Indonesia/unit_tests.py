...
class UnitTestsDataMinerYellowPagesIndonesia(unittest.TestCase):
    def test_extract_one_email(self):
        try:
            url = "https://yellowpages.co.id/bisnis/melawai-i-hotel"
            ...
            try:
                if soup\
                        .find("div", {"class": "list-number"}) is not None:
                    try:
                        if soup\
                                .find("div", {"class": "list-number"})\
                ...
                print("error div class list-number : " + str(e))
        except Exception as e:
