...
class UnitTestsDataMinerYellowPagesMalaysia(unittest.TestCase):
    def test_extract_one_email(self):
        try:
            url = "https://www.yellowpages.my/listing/bintangwarisan.html"
            ...
            try:
                if soup\
                        .find("section", {"class": "content-current"}) is not None:
                    try:
                        if soup \
                                .find("div", {"class": "bp-table"}) \
                    ...
                    print("no section class content-current")
            except Exception as e:
                print("error div class listing-detail : " + str(e))
        except Exception as e:
            print("error url base : " + str(e))
