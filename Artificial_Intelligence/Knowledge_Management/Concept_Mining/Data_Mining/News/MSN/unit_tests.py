...
class UnitTestsDataMiningMsnFr(unittest.TestCase):
...
class UnitTestsDataMiningMsnPossible(unittest.TestCase):
    def test_find_all_double_letter(self):
        print('test_find_all_double_letter')

        for c1 in ascii_lowercase:
            for c2 in ascii_lowercase:
                print('combination letter : ' + str(c1 + c2))

    def test_check_all_msn_possible(self):
        print('test_check_all_msn_possible')

        for c1 in ascii_lowercase:
            for c2 in ascii_lowercase:
                c3 = str(c1 + c2)

                url = "https://www.msn.com/" + c3 + "-" + c3 + "/"
                ...
                if soup.find('li', {'class': 'facebooklite'}) is not None:
                    print('website ok for : ' + c3)
                else:
                    print('no website for : ' + c3)
